...
class LoafnjugSpider(scrapy.Spider):
		name = "loafnjug"
		uid_list = []
		...
		def start_requests(self):
			for state in self.place_reader:
				request_url = "https://www.loafnjug.com/stores?address=%s&maxResults=200&open24Hours=false&radius=3000&showAllStores=true&storeType=&useLatLong=false" % state["code"]
