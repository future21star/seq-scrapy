...
class RanchomarketsSpider(scrapy.Spider):
		name = "ranchomarkets"
		uid_list = []
		start_urls = ['http://ranchomarkets.com']

		def parse(self, response):
			pdb.set_trace()
			file = cStringIO.StringIO(urllib.urlopen("http://ranchomarkets.com/images/FindUsBanner.png").read())
			img = Image.open(file)
